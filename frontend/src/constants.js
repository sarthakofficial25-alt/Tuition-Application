...
export const CLASS_DATA = [
    ...
    { id: '9', label: 'Class 9', subjects: ['Mathematics', 'Physics', 'Chemistry', 'Biology', 'Computer'] },
    { id: '10', label: 'Class 10', subjects: ['Mathematics', 'Physics', 'Chemistry', 'Biology', 'Computer'] },
];
